...
class HomeVC: UIViewController, GADBannerViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        bannerView.adUnitID = "ca-app-pub-2790005755690511/2483003975"
    ...
    func applyAnchors() {
        ...
        tweetWebView.anchors(top: tweetsLbl.bottomAnchor, topPad: 10, bottom: nil, bottomPad: 0, left: view.leftAnchor, leftPad: 30, right: view.rightAnchor, rightPad: -30, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        
        bannerView.anchors(top: tweetWebView.bottomAnchor, topPad: 10, bottom: view.bottomAnchor, bottomPad: -(self.tabBarController?.tabBar.frame.size.height)! - 10, left: nil, leftPad: 0, right: nil, rightPad: 0, centerX: view.centerXAnchor, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
