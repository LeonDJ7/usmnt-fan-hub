...
class PollsCell: UITableViewCell {
    ...
    let deleteBtn: UIButton = {
        ...
        btn.addTarget(self, action: #selector(deleteBtnPressed(sender:)), for: .touchUpInside)
        return btn
    }()
    ...
    func addSubviews() {
        ...
        contentView.addSubview(sensitiveContentWarningBtn)
        contentView.addSubview(blockedLbl)
        contentView.addSubview(unblockBtn)
                
    }
    
    func applyAnchors() {
        
        cellView.anchors(top: contentView.topAnchor, topPad: 5, bottom: contentView.bottomAnchor, bottomPad: -5, left: contentView.leftAnchor, leftPad: 5, right: contentView.rightAnchor, rightPad: -5, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        
        deleteBtn.anchors(top: cellView.topAnchor, topPad: 13, bottom: nil, bottomPad: 0, left: nil, leftPad: 0, right: cellView.rightAnchor, rightPad: -15, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 20, width: 20)
        
        reportBtn.anchors(top: cellView.topAnchor, topPad: 13, bottom: nil, bottomPad: 0, left: nil, leftPad: 0, right: cellView.rightAnchor, rightPad: -15, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 20, width: 20)
        ...
        sensitiveContentWarningBtn.anchors(top: nil, topPad: 0, bottom: nil, bottomPad: 0, left: nil, leftPad: 0, right: nil, rightPad: 0, centerX: contentView.centerXAnchor, centerXPad: 0, centerY: contentView.centerYAnchor, centerYPad: 0, height: 0, width: 0)
        
        blockedLbl.anchors(top: nil, topPad: 0, bottom: nil, bottomPad: 0, left: nil, leftPad: 0, right: nil, rightPad: 0, centerX: contentView.centerXAnchor, centerXPad: 0, centerY: contentView.centerYAnchor, centerYPad: 0, height: 0, width: 0)
        
        unblockBtn.anchors(top: blockedLbl.bottomAnchor, topPad: 0, bottom: nil, bottomPad: 0, left: contentView.leftAnchor, leftPad: 0, right: contentView.rightAnchor, rightPad: 0, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
