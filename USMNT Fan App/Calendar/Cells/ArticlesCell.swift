...
class ArticlesCell: UITableViewCell {
    ...
    func applyAnchors() {
        ...
        articleNameLbl.anchors(top: cellView.topAnchor, topPad: 10, bottom: cellView.bottomAnchor, bottomPad: -10, left: cellView.leftAnchor, leftPad: 15, right: cellView.rightAnchor, rightPad: -40, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
