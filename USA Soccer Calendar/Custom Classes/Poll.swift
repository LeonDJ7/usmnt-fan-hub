...
class Poll {
    ...
    init(question: String, author: String, answer1: String, answer2: String, answer3: String, answer4: String, answer1Score: Double, answer2Score: Double, answer3Score: Double, answer4Score: Double, timestamp: Double, totalAnswerOptions: Double) {
