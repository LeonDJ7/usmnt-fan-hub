...
class UserPollsVC: UIViewController {
    ...
    let tableView: UITableView = {
        ...
        tv.register(PollsTVCell.self, forCellReuseIdentifier: "userPollsCell")
        return tv
    }()
    ...
    func loadPolls() {
        ...
        Firestore.firestore().collection("Polls").whereField("authorUID", isEqualTo: uid ?? "").getDocuments { (snap, error) in
...
extension UserPollsVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCell(withIdentifier: "userPollsCell") as! PollsTVCell
