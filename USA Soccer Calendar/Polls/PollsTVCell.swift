...
class PollsTVCell: UITableViewCell {
    ...
    func addSubviews() {
        ...
        answer1Lbl.addSubview(answer1Btn)
        answer2Lbl.addSubview(answer2Btn)
        answer3Lbl.addSubview(answer3Btn)
        answer4Lbl.addSubview(answer4Btn)
    ...
    func applyAnchors() {
        ...
        authorLbl.anchors(top: timeRemainingLbl.bottomAnchor, topPad: 5, bottom: nil, bottomPad: 0, left: cellView.leftAnchor, leftPad: 5, right: cellView.rightAnchor, rightPad: -30, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        ...
        answer1Lbl.anchors(top: authorLbl.bottomAnchor, topPad: 10, bottom: nil, bottomPad: 0, left: cellView.leftAnchor, leftPad: 5, right: cellView.rightAnchor, rightPad: -5, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 50, width: 0)
