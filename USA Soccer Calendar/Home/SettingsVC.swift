...
class SettingsVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        setupLayout()
        getUserImage() // retrieves user profile image from firebase storage
    ...
    func applyAnchors() {
        ...
        let usableScreenWidth = view.frame.width - 100 // width between left anchor of view and side bar
        
        if #available(iOS 11.0, *) {
            sideBarView.anchors(top: view.topAnchor, topPad: view.safeAreaInsets.top + 50, bottom: view.bottomAnchor, bottomPad: -((tabBarController?.tabBar.frame.height)!)-50, left: view.leftAnchor, leftPad: usableScreenWidth, right: view.rightAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        } else {
            sideBarView.anchors(top: view.topAnchor, topPad: 50, bottom: view.bottomAnchor, bottomPad: -((tabBarController?.tabBar.frame.height)!)-50, left: view.leftAnchor, leftPad: usableScreenWidth, right: view.rightAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        }
        
        profileLbl.anchors(top: view.topAnchor, topPad: 100, bottom: nil, bottomPad: 0, left: view.leftAnchor, leftPad: 50, right: sideBarView.leftAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        ...
        usernameLbl.anchors(top: profileImageView.bottomAnchor, topPad: 30, bottom: nil, bottomPad: 0, left: view.leftAnchor, leftPad: 50, right: sideBarView.leftAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        
        usernameTF.anchors(top: usernameLbl.bottomAnchor, topPad: 5, bottom: nil, bottomPad: 0, left: view.leftAnchor, leftPad: 50, right: sideBarView.leftAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        
        logOutBtn.anchors(top: usernameTF.bottomAnchor, topPad: 20, bottom: nil, bottomPad: 0, left: view.leftAnchor, leftPad: 50, right: sideBarView.leftAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        
        termsBtn.anchors(top: logOutBtn.bottomAnchor, topPad: 20, bottom: nil, bottomPad: 0, left: view.leftAnchor, leftPad: 50, right: sideBarView.leftAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
        
        privacyBtn.anchors(top: termsBtn.bottomAnchor, topPad: 20, bottom: nil, bottomPad: 0, left: view.leftAnchor, leftPad: 50, right: sideBarView.leftAnchor, rightPad: -50, centerX: nil, centerXPad: 0, centerY: nil, centerYPad: 0, height: 0, width: 0)
    ...
    @objc func confirmUsername() {
        ...
        // search database to see if username is taken
        ...
        Firestore.firestore().collection("Users").getDocuments { (snap, error) in
            ...
            if let error = error {
                ...
                for document in (snap?.documents)! {
                    ...
                    if (data["username"] as? String == self.usernameTF.text) {
                        usernameTaken = true
                    }
                ...
                if (usernameTaken == false) {
                    ...
                    AlertController.showAlert(self, title: ":(", message: "username already taken")
                }
